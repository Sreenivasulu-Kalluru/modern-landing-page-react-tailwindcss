...
const Footer = () => {
  ...
  return (
    <footer initial="hidden" whileInView="show" className="bg-gray-50">
        ...
        <div className="border-t border-gray-200 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-600 text-sm">
              Copyright © {new Date().getFullYear()} The Next Design. All rights
              reserved.
            </p>
            <p className="text-gray-600 text-sm">Created by VSK</p>
          </div>
        </div>
      </div>
    </footer>
